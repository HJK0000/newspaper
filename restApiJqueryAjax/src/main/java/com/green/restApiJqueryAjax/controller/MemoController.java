package com.green.restApiJqueryAjax.controller;
...
import com.green.restApiJqueryAjax.dto.MemoDto;
import com.green.restApiJqueryAjax.entity.Memo;
import com.green.restApiJqueryAjax.repository.MemoRepository;
...
public class MemoController {
	...
	@PostMapping("/memo")
	public MemoDto postMemo(@RequestBody MemoDto memoDto) { // json으로 넘어오는 거 아니면 그냥 커멘드 객체로 받을 수 있음
